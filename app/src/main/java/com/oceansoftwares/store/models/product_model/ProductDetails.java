package com.oceansoftwares.store.models.product_model;
...
public class ProductDetails implements Parcelable {
    ...
    @SerializedName("products_hours")
    @Expose
    private String productsHours;
    ...
    public String getProductsHours() {
        return productsHours;
    }

    public void setProductsHours(String productsHours) {
        this.productsHours = productsHours;
    }
