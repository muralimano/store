            ...
            holder.cart_item_quantity_minusBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (number[0] > 1)
                    {
                        ...
                        My_Cart.UpdateQTY(cartProduct.getCustomersBasketProduct().getProductsName(),String.valueOf(number[0]),String.valueOf(price));
            ...
            holder.cart_item_removeBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    My_Cart.DeleteCartItem
                            (
                                    cartProduct.getCustomersBasketProduct().getProductsName()
                            );
