package com.oceansoftwares.store.app;
...
public class MyAppPrefsManager {
    ...
    private static final String USER_RES_REMARKS  = "res_remarks";
    ...
    public void setResRemarks(String langCode) {
        prefsEditor.putString(USER_RES_REMARKS, langCode);
        prefsEditor.commit();
    }

    public String getResRemarks() {
        return sharedPreferences.getString(USER_RES_REMARKS, "en");
    }

    public void setCustomerEmail(String langCode) {
        prefsEditor.putString(CUSTOMER_EMAIL, langCode);
        prefsEditor.commit();
    }

    public String getCustomerEmail() {
        return sharedPreferences.getString(CUSTOMER_EMAIL, "en");
    }
