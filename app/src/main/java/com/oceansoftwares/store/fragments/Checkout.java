...
import com.oceansoftwares.store.activities.adapters.CheckoutItemsAdapter;
import com.oceansoftwares.store.activities.adapters.CouponsAdapter;
import com.oceansoftwares.store.activities.adapters.DemoCouponsListAdapter;
...
import com.oceansoftwares.store.models.address_model.AddressDetails;
...
import com.oceansoftwares.store.models.order_model.PostProducts;
import com.oceansoftwares.store.models.order_model.PostProductsAttributes;
...
import com.oceansoftwares.store.models.payment_model.PaymentMethodsInfo;
...
import com.oceansoftwares.store.models.shipping_model.ShippingService;
        ...
        checkout_order_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                try {
                    ...
                    Date d = new SimpleDateFormat("HH:mm:ss").parse(opentime);
                    Calendar calendar0 = Calendar.getInstance();
                    calendar0.setTime(d);
                    calendar0.add(Calendar.DATE, 1);

                    Date d1 = new SimpleDateFormat("HH:mm:ss").parse(closetime);
