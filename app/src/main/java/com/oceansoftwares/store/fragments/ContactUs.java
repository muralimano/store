...
import com.oceansoftwares.store.customs.CustomScrollMapFragment;
...
public class ContactUs extends Fragment implements OnMapReadyCallback {
    ...
    Button btn_contact_us,btn_submit;
    EditText ed_name, ed_email, ed_message,ed_comment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(comment.equals("")){
                    ed_comment.setError("Pl Enter Comment");
                    //Toast.makeText(getContext(),"Pl Enter Comment",Toast.LENGTH_LONG).show();
                }else{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String locationDetails="Lat: "+latitude+"Longitude: "+longitude;

        Toast.makeText(getContext(),locationDetails,Toast.LENGTH_LONG).show();
    ...
    private void drawMarker(double latitude, double longitude) {
       ...
       // markerOptions.title(ConstantValues.APP_HEADER);
        markerOptions.title("Uth Software");
