...
import com.oceansoftwares.store.models.contact_model.ContactUsData;
import com.oceansoftwares.store.models.device_model.AppSettingsData;
import com.oceansoftwares.store.models.filter_model.get_filters.FilterData;
import com.oceansoftwares.store.models.language_model.LanguageData;
import com.oceansoftwares.store.models.news_model.all_news.NewsData;
import com.oceansoftwares.store.models.news_model.news_categories.NewsCategoryData;
import com.oceansoftwares.store.models.pages_model.PagesData;
import com.oceansoftwares.store.models.product_model.GetAllProducts;
import com.oceansoftwares.store.models.coupons_model.CouponsData;
import com.oceansoftwares.store.models.payment_model.PaymentMethodsData;
import com.oceansoftwares.store.models.shipping_model.PostTaxAndShippingData;
import com.oceansoftwares.store.models.order_model.OrderData;
import com.oceansoftwares.store.models.payment_model.GetBrainTreeToken;
import com.oceansoftwares.store.models.order_model.PostOrder;
import com.oceansoftwares.store.models.product_model.ProductData;
import com.oceansoftwares.store.models.search_model.SearchData;
import com.oceansoftwares.store.models.shipping_model.ShippingRateData;
...
public interface APIRequests {
    ...
    @FormUrlEncoded
    @POST("getCustomerID")
    Call<UserData> getcustomerId(@Field("customers_email_address") String customers_email_address);
    ...
    @FormUrlEncoded
    @POST("getregisterDevices")
    Call<UserData> getregisterDeviceToFCM( @Field("customers_id") String customers_id);
    ...
    Call<ResStatus> getResStatus();

    //******************** Comment Data ********************//

    @FormUrlEncoded
    @POST("addComment")
    Call<Comment> addComment(@Field("comment") String comment);
